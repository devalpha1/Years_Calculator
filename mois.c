...
void moisActuel(int *mois, int *jour, int *compteur_jour )
{
    ...
    *compteur_jour += nombreDeJourAParcourir;
...
void estBissextile(int *anne_a_convertir, short *bissextile)
{
    ...
    int divisible4 = 0, divisible100 = 0, reste_quatre = *anne_a_convertir % 4;
       //int nombrejour = 0;
